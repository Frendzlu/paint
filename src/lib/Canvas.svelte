<script lang="ts">
	...
	onMount(() => {
		...
		imageStack.push(context.getImageData(0, 0, canvasRef.width, canvasRef.height))
	...
	const setListeners = () => {
		...
		iconRef.addEventListener("mouseleave", () => listenerHandlers.emptyCanvas(iconRef))
	}
...
<div id="canvasDiv">
	<canvas id="iconCanvas" bind:this={iconRef} width="150" height="150" style="z-index: 10000;"></canvas>
